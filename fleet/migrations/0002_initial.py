    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supply', models.CharField(choices=[('SCARCE', 'Scarce'), ('LIMITED', 'Limited'), ('MODERATE', 'Moderate'), ('ABUNDANT', 'Abundant')], max_length=500, verbose_name='the supply of the ship at this shipyard.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faction_symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='factions.faction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_system_symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systems.system')),
                ('route', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fleet.shipnavroute')),
