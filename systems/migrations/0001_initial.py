...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trade_type', models.CharField(choices=[('EXPORT', 'Export'), ('IMPORT', 'Import'), ('EXCHANGE', 'Exchange')], max_length=500)),
                ('volume', models.IntegerField(validators=[django.core.validators.MinValueValidator(1)], verbose_name='the maximum number of units that can be purchased or sold at this market in a single trade for this good. Trade volume also gives an indication of price volatility. A market with a low trade volume will have large price swings, while high trade volume will be more resilient to price changes.')),
                ('supply', models.CharField(choices=[('SCARCE', 'Scarce'), ('LIMITED', 'Limited'), ('MODERATE', 'Moderate'), ('HIGH', 'High'), ('ABUNDANT', 'Abundant')], max_length=500)),
                ...
                ('purchase_price', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='the price at which this good can be purchased from the market.')),
                ('sell_price', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='the price at which this good can be sold to the market.')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_under_construction', models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.CreateModel(
            name='Chart',
            fields=[
                ('waypoint', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='chart', serialize=False, to='systems.waypoint', verbose_name='The chart of a system or waypoint, which makes the location visible to other agents.')),
        ...
        migrations.CreateModel(
            name='Market',
            fields=[
                ('waypoint', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='market', serialize=False, to='systems.waypoint')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trait', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='waypoint_links', to='systems.waypointtrait')),
                ('waypoint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trait_links', to='systems.waypoint')),
            ],
        ),
        migrations.CreateModel(
